...
exports.create = function (parent) {
    ...
    return {
        ...
        use: function (protocol, impl) {
            var handlers, handler, rx, index, removed;
            ...
            if(!handler) {
                handler = handlers[protocol] = {
                    ...
                    regex: this.regex('protocol', protocol),
        ...
        resolve: function resolve(src) {
            ...
            if (typeof src === 'object' && src !== null) {
                ...
                valid = this.regex('protocol', protocols);

                if (valid.test(src)) {

                    chain = this.regex('chained', protocols);
